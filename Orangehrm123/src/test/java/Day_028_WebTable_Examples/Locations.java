...
public class Locations
{
	...
	public void ExportLocations(WebDriver driver )throws Exception
	{  
		this.driver=driver;
				 ...
				 public void call_allmethods(int iRow )throws Exception
					...
					String str=String.valueOf(iRow);
						...
						l1.OrangeHRMSigninClick();
						 ...
						 WebElement ele=findElement(By.xpath("//*[@id='menu_admin_viewAdminModule']"));
				         
						 WebElement ele1=findElement(By.xpath("//*[@id=\'menu_admin_Organization\']"));
						 WebElement ele2=findElement(By.xpath("//*[@id=\'menu_admin_viewLocations\']"));
				         
						 
						 actions.moveToElement(ele).moveToElement(ele1).moveToElement(ele2).click().build().perform();
						 
						
						 Locations Ae=new  Locations();		
						 Ae.ExportLocations(driver);
					...
					{ 
				        ...
				        //No. of columns
						 String Locationcoloums="//*[@id=\'resultTable\']/thead/tr/th";//*[@id="resultTable"]/thead/tr/th
						 List<WebElement>  columns = driver.findElements(By.xpath(Locationcoloums)); 
				        ...
				        //No.of rows 
						 String LocationRows="//*[@id=\'resultTable\']/tbody/tr[1]/td[2]/a";
